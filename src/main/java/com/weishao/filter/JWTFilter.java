...
import com.weishao.shiro.JWTToken;
...
public class JWTFilter extends BasicHttpAuthenticationFilter {
	...
	protected boolean isLoginAttempt(ServletRequest request, ServletResponse response) {
		...
		logger.info("Http Header Authorization={}",authzHeader);
	...
	protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
		...
		if (authorization == null || !authorization.startsWith(JWTUtil.TOKEN_PREFIX)) {
			...
			logger.info("error request path:{}",httpRequest.getPathInfo());
		}
		logger.info("Http Header token={}",authorization);
